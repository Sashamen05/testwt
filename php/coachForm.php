...
<body>
    <div class="container">
     ...
     <div class="account">
                ...
                <a href="competitorForm.php" class="btn btn-primary btn_add mt-2">Add Competitor</a>
            ...
            <div class="form_coach">
                <h2>Add Coach</h2>
                <form action="checkCoach.php" method="post" enctype="multipart/form-data">
                    ...
                    <input type="submit" class="mt-3 btn btn-success reg_btn" value="Add">
                </form>
            </div>
        </nav>
    </div>
